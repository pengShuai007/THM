...
import APP.Model.BaseEntity;
	...
	public  class SYS_PARAMETER extends BaseEntity
     { 
         ...
         private String PARA_SOURCE;

         public void setPARA_SOURCE(String PARA_SOURCE )
         { 
             PARA_TYPE = PARA_SOURCE;
             this.AddUpdateAttribute("PARA_SOURCE");
         }
     public String getPARA_SOURCE()
         { 
             return PARA_SOURCE;
         }
