...
public class DictionaryConfigRuleSet extends RuleSetBase {
	String pattern = "appSystem";

	public DictionaryConfigRuleSet() {
		this("");
	}

	public DictionaryConfigRuleSet(String namespaceURI) {
		super();
...
//		
		...
		digester.addRule("appSystem/param", new DictionaryConfigRule());
