...
public class ProjectConfigRuleSet extends RuleSetBase {
	String pattern = "appSystem";

	public ProjectConfigRuleSet() {
		this("");
	}

	public ProjectConfigRuleSet(String namespaceURI) {
		super();
...
//		
		...
		digester.addRule("appSystem/param", new ProjectConfigRule());
