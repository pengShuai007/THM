...
public class DES {
	 ...
	 * 加密密钥
	 */
	private String firstKey="KYEE";
	private String secondKey="HRP";
	private String thridKey="!@#$";
	...
	* 描述:DES加密
	* 作者:houhy
	* 日期:2015年1月6日下午1:42:50
	* @param data
	* @return
	* </pre>
	*/
	public String Des_Encrypt(String data){
		return strEnc(data,firstKey,secondKey,thridKey);
	}
    
    /**
    * <pre>
    * 任务:
    * 描述:encrypt the string to string made up of hex return the encrypted string
    * 作者:houhy
    * 日期:2015年1月6日下午12:06:27
    * @param data
    * @param firstKey
    * @param secondKey
    * @param thirdKey
	...
	* 描述:DES解密
	* 作者:houhy
	* 日期:2015年1月6日下午1:43:52
	* @param data
	* @return
	* </pre>
	*/
	public String Des_Decrypt(String data){
		return strDec(data,firstKey,secondKey,thridKey);
	}

    /**
    * <pre>
    * 任务:
    * 描述:decrypt the encrypted string to the original string
    * 作者:houhy
    * 日期:2015年1月6日下午12:06:50
    * @param data
    * @param firstKey
    * @param secondKey
    * @param thirdKey
