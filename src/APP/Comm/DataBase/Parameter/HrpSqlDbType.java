...
//摘要：指定要用于 System.Data.SqlClient.SqlParameter 中的字段和属性的 SQL Server 特定的数据类型。
//创建者：张宝锋
//创建时间：2012-12-27
public enum HrpSqlDbType
{
	// 摘要:
	...
	private static java.util.HashMap<Integer, HrpSqlDbType> mappings;
	private synchronized static java.util.HashMap<Integer, HrpSqlDbType> getMappings()
	{
		if (mappings == null)
		{
			mappings = new java.util.HashMap<Integer, HrpSqlDbType>();
		}
		return mappings;
	}

	private HrpSqlDbType(int value)
	{
		intValue = value;
		HrpSqlDbType.getMappings().put(value, this);
	}
	...
	public static HrpSqlDbType forValue(int value)
	{
